...
export default function Home() {
  ...
  function renderListTexts(){
    const listTexts = ['A panel to display and handle recieved orders', 'Add, delete & edit menu', 'Digital table system with QR code', 'Place orders from a specific table','Enhanced restaurant management']
    return(
      <List>
        {listTexts.map(text =>
          <ListItem key={text}>
